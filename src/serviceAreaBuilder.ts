...
export function resolveAreaTypeId(type: string | undefined): number | null {
  if (!type) return null;
 ...
 */
export const EVERYWHERE_AREA: ServiceAreaArea = {
  areaId: 1,
  mapId: null,
  areaInfo: {
    locationInfo: {
 ...
 */
export function buildSupportedAreas(
  rooms: RoombaRoomConfig[] | undefined,
  maps: RoombaMapConfig[] | undefined,
): ServiceAreaArea[] {
 ...
 */
export function buildSupportedMaps(maps: RoombaMapConfig[] | undefined): ServiceAreaMap[] {
