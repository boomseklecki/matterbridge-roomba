 ...
 */
export function statusToRunMode(status) {
    if (status.running) {
 ...
 */
export function statusToOperationalState(status) {
 ...
 */
export function errorCodeToMatterError(errorCode, opts = {}) {
 ...
 */
export function batteryToChargeLevel(batteryPct) {
